...
def extract_language_table(input_path: str, output_path: str, label_key: str) -> None:
    """
...
if __name__ == "__main__":
    extract_language_table(
        input_path="/workspaces/Chat-Immigration/assets/rules_factores/orginal_factores/www.canada.ca__en_immigration_refugees_citizenship_services_immigrate_canada_express_entry_check_score_crs_criteria_html_table_3.json",

...
def get_age_factors(input_json_path: str, extracted_output_path: str) -> AgeFactors:
    ...
    try:
        ...
        from src.controllers import exteact_age_json
    ...
    try:
        ...
        exteact_age_json(input_path=input_json_path, output_path=extracted_output_path)
...
def main():
    ...
    input_json_path = app_settings.AGE_TAPLE
    extracted_output_path = "age_factors.json"
